...
const Pokemon = function (name, type, specie, fly = false) {
    ...
    this.evolve = function () {
        if (myMethods.inctanceOf(this, this.Next)) {
...
const Charmander = function () {
    Object.assign(this, new Pokemon('Charmander', 'Fire', 'Lizard Pokémon'));
};
const Charmeleon = function () {
    Object.assign(this, new Pokemon('Charmeleon', 'Fire', 'Flame Pokémon'));
};
const Charizard = function () {
    Object.assign(this, new Pokemon('Charizard', 'Fire', 'Flame Pokémon', true));
};
myMethods.evolvingSequence(Charmander, Charmeleon, Charizard);

const Pichu = function () {
    Object.assign(this, new Pokemon('Pichu', 'Electric', 'Mouse Pokémon'));
};
const Pikachu = function () {
    Object.assign(this, new Pokemon('Pikachu', 'Electric', 'Mouse Pokémon'));
};
const Raichu = function () {
    Object.assign(this, new Pokemon('Raichu', 'Electric', 'Mouse Pokémon'));
};
